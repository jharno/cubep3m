...
cd ../dist_init
rm -f dist_init
mpif77 -shared-intel -fpp -g -O3 -xT -DBINARY dist_init_dm.f90 -o dist_init  -L$MCKENZIE_FFTW_LIB_PATH -I$MCKENZIE_FFTW_INC_PATH -lsrfftw_mpi -lsrfftw -lsfftw_mpi -lsfftw -lm -ldl
cd ../halo_merge
rm -f halo_merge
