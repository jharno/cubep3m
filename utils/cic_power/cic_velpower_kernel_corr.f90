...
! -------------------------------------------------------------------------------------------------------
  ...
  do cur_checkpoint = 1, num_checkpoints
    ...
    do cur_dimension = 1, 3 ! each v_x, v_y, v_z
...
subroutine momentum_density 
    !
    ! Bin particles in position space and construct their momentum density
    ! 
    ...
    do i = 1, np_local
        ...
        x=xvp(1, i) - 0.5 !! Positions
        y=xvp(2, i) - 0.5
        z=xvp(3, i) - 0.5

        vel_dim = xvp(3 + cur_dimension, i) !! Velocity along given dimension
