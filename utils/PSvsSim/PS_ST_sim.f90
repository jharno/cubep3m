program PS_check
  ...
  !Compile with: ifort PS_ST_sim.f90 deltac.f growth.f sigma_cobe_CMBfast.f spline.f90 splint.f90 -o PS_ST_sim
  implicit none
  include '../../parameters'
  !
...
!  integer(kind=4) :: odc
  ...
  real*8,parameter :: n_box=1024 !128 !3456 !128 ! by T.T. Lu !cells/side
