...
subroutine darkmatter(command)
    ...
    if (command == 0) then
        ...
        call powerspectrum(slab2, slab2, pkdimdm0(cur_dimension, :, :))
 
    else if (command == 1) then
    
        call powerspectrum(slab2, slab2, pkdimdm1(cur_dimension, :, :))

    else if (command == 2) then

        call powerspectrum(slab2, slab2, pkdimdm2(cur_dimension, :, :))
