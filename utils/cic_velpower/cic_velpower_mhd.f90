...
#ifdef KAISER
   fn=output_path//z_write(1:len_trim(z_write))//prefix//'-RSD_mhd.dat' 
#else
   fn=output_path//z_write(1:len_trim(z_write))//prefix//'_mhd.dat' 
#endif
...
subroutine gasmatter(command)
    ...
    if (rank == 0) print *, "Gas total momentum density = ", sum_dm, " command = ", command
