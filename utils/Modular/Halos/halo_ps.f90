...
program density_ps
  ...
  !HA1xHA1
  if (rank==0) write(*,*) 'Computing halo group 1 autospectrum'
  ...
  !!Write spectrum
  fnd = dir//'ps/'//redshift//'delta_denha_g1g1.dat'
  ...
  !HA2xHA2
  if (rank==0) write(*,*) 'Computing halo group 2 autospectrum'
  call reset_pencil
  !$omp workshare
    cube=0.0
  !$omp end workshare
  ...
  !!Write spectrum
  fnd = dir//'ps/'//redshift//'delta_denha_g2g2.dat'
  if (rank==0) call write_spectrum(fnd,kbins,kpow,pow,kernel)

  !HA1xHA2
  if (rank==0) write(*,*) 'Computing cross spectrum'
  kernel=0.0
  pow = 0.0
  kpow = 0.0
  call crosspowerspectrum(pow,kpow,kbins,slab,slab2,kernel)
  !!Write spectrum
  fnd = dir//'ps/'//redshift//'delta_denha_g1g2.dat'
  if (rank==0) call write_spectrum(fnd,kbins,kpow,pow,kernel)
