!! Computes pp force between particles of neighboring fine cells
 subroutine pp_extended_force(tile,thread)
   ...
   integer ipl_ext(mesh_scale+2*buff_fm,mesh_scale+2*buff_fm,mesh_scale+buff_fm)
   ...
   write(*,*) 'Calculated BC:', cic_l, cic_h    
#endif
   ...
   do k = cic_l(3), cic_h(3)
      do j = cic_l(2), cic_h(2)
         do i = cic_l(1), cic_h(1)
            ...
            do
               ...
               do im=1,3
                  ...
                  if(i2(im)<1) then
                     ...
                     if(i2(im)<1) then
                        !write(*,*) 'also in the global buffer !' , i2(im), x(im)
                        i2(im) = i2(im) + mesh_scale
                     endif
               ...
               !Get particle count
               ipl_ext(i2(1)+offset(1),i2(2)+offset(2),i2(3)+offset(3))=ipl_ext(i2(1)+offset(1),i2(2)+offset(2),i2(3)+offset(3))+1
               if (ipl_ext(i2(1)+offset(1),i2(2)+offset(2),i2(3)+offset(3))>max_llf) then
               ...
               llf_ext(ipl_ext(i2(1)+offset(1),i2(2)+offset(2),i2(3)+offset(3)),i2(1)+offset(1),i2(2)+offset(2),i2(3)+offset(3),thread)=pp
            ...
            do
               ...
               ! Verify that particle in x-buffer 
               if(i2(1) > mesh_scale - buff_fm)  then
            ...
            do
               ...
               ! Verify that particle in y-buffer 
               if(i2(2) >  mesh_scale - buff_fm)  then
            ...
            do
               ...
               ! Verify that particle in xy-buffer 
               if(i2(1) <= buff_fm .and. i2(2) > mesh_scale - buff_fm)  then
            ...
            do
               ...
               ! Verify that particle in xy-buffer 
               if(i2(1) > mesh_scale - buff_fm .and. i2(2) <= buff_fm)  then
            ...
            do
               ...
               ! Verify that particle in xy-buffer 
               if(i2(1) > mesh_scale -  buff_fm .and. i2(2) > mesh_scale -  buff_fm)  then
     ...
     !write(*,*) 'xy = 55, along z-axis', ipl_ext(5,5,1), ipl_ext(5,5,2), ipl_ext(5,5,3), ipl_ext(5,5,4), ipl_ext(5,5,5), ipl_ext(5,5,6)
            ...
            do
               ...
               ! Verify that particle in xz-buffer 
               if(i2(1) > mesh_scale - buff_fm .and. i2(3) <= buff_fm)  then
            ...
            do
               ...
               ! Verify that particle in yz-buffer 
               if(i2(2) > mesh_scale - buff_fm .and. i2(3) <= buff_fm)  then
            ...
            do
               ...
               ! Verify that particle in xyz-buffer 
               if(i2(1) > mesh_scale - buff_fm .and. i2(2) <= buff_fm .and. i2(3) <= buff_fm)  then
            ...
            do
               ...
               ! Verify that particle in xyz-buffer 
               if(i2(1) <= buff_fm .and. i2(2) > mesh_scale - buff_fm .and. i2(3) <= buff_fm)  then
            ...
            do
               ...
               ! Verify that particle in xyz-buffer 
               if(i2(1) > mesh_scale - buff_fm .and. i2(2) > mesh_scale - buff_fm .and. i2(3) <= buff_fm)  then
